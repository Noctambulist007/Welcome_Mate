...
mixin _$ChatResponse {
  ...
  @JsonKey(name: 'data')
  ChatDataResponse get data => throw _privateConstructorUsedError;
...
abstract class $ChatResponseCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'data') ChatDataResponse data,
    @JsonKey(name: 'timestamp') String timestamp,
  });

  $ChatDataResponseCopyWith<$Res> get data;
}
...
class _$ChatResponseCopyWithImpl<$Res, $Val extends ChatResponse>
  ...
  @pragma('vm:prefer-inline')
  $ChatDataResponseCopyWith<$Res> get data {
    return $ChatDataResponseCopyWith<$Res>(_value.data, (value) {
...
class _$ChatResponseImpl implements _ChatResponse {
  ...
  @override
  String toString() {
    return 'ChatResponse(success: $success, message: $message, data: $data, timestamp: $timestamp)';
  }
...
abstract class _ChatResponse implements ChatResponse {
  const factory _ChatResponse({
    ...
    @JsonKey(name: 'data') required final ChatDataResponse data,
