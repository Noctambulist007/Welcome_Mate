...
mixin _$AuthResponse {
  ...
  @JsonKey(name: 'data')
  AuthDataResponse? get data => throw _privateConstructorUsedError;
...
abstract class $AuthResponseCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'data') AuthDataResponse? data,
...
class _$AuthResponseCopyWithImpl<$Res, $Val extends AuthResponse>
  ...
  $AuthDataResponseCopyWith<$Res>? get data {
    ...
    return $AuthDataResponseCopyWith<$Res>(_value.data!, (value) {
...
class _$AuthResponseImpl implements _AuthResponse {
  ...
  @override
  String toString() {
    return 'AuthResponse(success: $success, message: $message, data: $data, timestamp: $timestamp)';
  }
...
abstract class _AuthResponse implements AuthResponse {
  const factory _AuthResponse({
    ...
    @JsonKey(name: 'data') required final AuthDataResponse? data,
