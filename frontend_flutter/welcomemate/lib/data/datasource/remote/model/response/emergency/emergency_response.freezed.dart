...
mixin _$EmergencyResponse {
  ...
  @JsonKey(name: 'data')
  EmergencyDataResponse get data => throw _privateConstructorUsedError;
  @JsonKey(name: 'timestamp')
  String get timestamp => throw _privateConstructorUsedError;

  /// Serializes this EmergencyResponse to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of EmergencyResponse
...
abstract class $EmergencyResponseCopyWith<$Res> {
  factory $EmergencyResponseCopyWith(
    ...
    $Res Function(EmergencyResponse) then,
  ) = _$EmergencyResponseCopyWithImpl<$Res, EmergencyResponse>;
  @useResult
  $Res call({
    @JsonKey(name: 'success') bool success,
    @JsonKey(name: 'message') String message,
    @JsonKey(name: 'data') EmergencyDataResponse data,
    @JsonKey(name: 'timestamp') String timestamp,
  });

  $EmergencyDataResponseCopyWith<$Res> get data;
}
...
class _$EmergencyResponseCopyWithImpl<$Res, $Val extends EmergencyResponse>
  ...
  @pragma('vm:prefer-inline')
  $EmergencyDataResponseCopyWith<$Res> get data {
    return $EmergencyDataResponseCopyWith<$Res>(_value.data, (value) {
...
abstract class _$$EmergencyResponseImplCopyWith<$Res>
    implements $EmergencyResponseCopyWith<$Res> {
  factory _$$EmergencyResponseImplCopyWith(
    _$EmergencyResponseImpl value,
...
class __$$EmergencyResponseImplCopyWithImpl<$Res>
  ...
  __$$EmergencyResponseImplCopyWithImpl(
    _$EmergencyResponseImpl _value,
...
class _$EmergencyResponseImpl implements _EmergencyResponse {
  ...
  @override
  @JsonKey(name: 'data')
  final EmergencyDataResponse data;
  @override
  @JsonKey(name: 'timestamp')
  ...
  @override
  String toString() {
    return 'EmergencyResponse(success: $success, message: $message, data: $data, timestamp: $timestamp)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$EmergencyResponseImplToJson(this);
  }
}
...
abstract class _EmergencyResponse implements EmergencyResponse {
  const factory _EmergencyResponse({
    ...
    @JsonKey(name: 'data') required final EmergencyDataResponse data,
  ...
  @override
  @JsonKey(name: 'data')
  EmergencyDataResponse get data;
  @override
  @JsonKey(name: 'timestamp')
