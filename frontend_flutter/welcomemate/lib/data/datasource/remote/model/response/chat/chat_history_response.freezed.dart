...
mixin _$ChatHistoryResponse {
  ...
  @JsonKey(name: 'data')
  ChatHistoryDataResponse get data => throw _privateConstructorUsedError;
...
abstract class $ChatHistoryResponseCopyWith<$Res> {
  ...
  $Res call({
    ...
    @JsonKey(name: 'data') ChatHistoryDataResponse data,
    @JsonKey(name: 'timestamp') String timestamp,
  });

  $ChatHistoryDataResponseCopyWith<$Res> get data;
}
...
class _$ChatHistoryResponseCopyWithImpl<$Res, $Val extends ChatHistoryResponse>
  ...
  @pragma('vm:prefer-inline')
  $ChatHistoryDataResponseCopyWith<$Res> get data {
    return $ChatHistoryDataResponseCopyWith<$Res>(_value.data, (value) {
...
class _$ChatHistoryResponseImpl implements _ChatHistoryResponse {
  ...
  @override
  @JsonKey(name: 'data')
  final ChatHistoryDataResponse data;
  @override
  @JsonKey(name: 'timestamp')
  ...
  @override
  String toString() {
    return 'ChatHistoryResponse(success: $success, message: $message, data: $data, timestamp: $timestamp)';
  }
...
abstract class _ChatHistoryResponse implements ChatHistoryResponse {
  const factory _ChatHistoryResponse({
    ...
    @JsonKey(name: 'data') required final ChatHistoryDataResponse data,
  ...
  @override
  @JsonKey(name: 'data')
  ChatHistoryDataResponse get data;
  @override
  @JsonKey(name: 'timestamp')
